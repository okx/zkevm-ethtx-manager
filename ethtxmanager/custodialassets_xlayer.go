...
func (c *Client) signTx(mTx ethxTypes.MonitoredTx, tx *types.Transaction) (*types.Transaction, error) {
...
func (s *sequenceBatchesArgs) marshal(contractAddress common.Address, mTx ethxTypes.MonitoredTx) (string, error) {
	if s == nil {
...
func (v *verifyBatchesTrustedAggregatorArgs) marshal(contractAddress common.Address, mTx ethxTypes.MonitoredTx) (string, error) {
	if v == nil {
